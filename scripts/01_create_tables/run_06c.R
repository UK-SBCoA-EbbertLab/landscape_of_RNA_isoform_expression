...
#SBATCH --job-name=housekeeping_using_gini      # Job name
...
singularity exec /project/mteb223_uksr/singularity_files/pathway_analysis_2023_10_30_add_gini.sif Rscript 06c_gini_coefficent_confirmation.R
