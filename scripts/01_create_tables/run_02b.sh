...
#SBATCH --job-name=pvalue_stat      # Job name
...
singularity exec /project/mteb223_uksr/singularity_files/pathway_analysis_2023_10_30.sif Rscript 02b_create_isoform_counts_tables_by_tiss.R
