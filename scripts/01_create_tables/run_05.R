...
#SBATCH --job-name=new_isoforms_in_gtex      # Job name
...
singularity exec /project/mteb223_uksr/singularity_files/pathway_analysis_2023_10_30.sif Rscript 05_GTEx_expression_of_new_isoforms.R
