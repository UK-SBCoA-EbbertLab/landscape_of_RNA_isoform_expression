...
#SBATCH --job-name=n_isoform_heatmap      # Job name
...
singularity exec /project/mteb223_uksr/singularity_files/pathway_analysis_2023_10_30.sif Rscript 03a_interrogate_specific_genes.R $1
