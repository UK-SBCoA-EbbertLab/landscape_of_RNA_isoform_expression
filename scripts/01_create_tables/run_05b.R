...
#SBATCH --job-name=housekeeping_and_preferential      # Job name
...
singularity exec /project/mteb223_uksr/singularity_files/pathway_analysis_2023_10_30.sif Rscript 05b_determine_housekeeping_and_preferential.R
