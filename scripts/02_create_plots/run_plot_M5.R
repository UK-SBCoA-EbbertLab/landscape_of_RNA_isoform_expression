...
#SBATCH --job-name=M5_new_isoforms       # Job name
...
singularity exec /project/mteb223_uksr/singularity_files/pathway_analysis_2023_10_30.sif Rscript plot_M5_GTEx_expression_of_our_new_isoforms.R
