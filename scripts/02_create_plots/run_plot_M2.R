...
#SBATCH --job-name=M2_gtex_expression      # Job name
...
singularity exec /project/mteb223_uksr/singularity_files/pathway_analysis_2023_10_30.sif Rscript plot_M2_expression_of_transcripts_in_gtex.R
